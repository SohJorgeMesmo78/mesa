...
export type GameEngineType = 'identity-reveal' | 'scale-ordering' | 'hidden-role' | 'timed-turns' | 'question-pairs' | 'comparison-reveal' | 'contact-word' | 'rating' | 'word-list' | 'letter-chain' | 'social-deduction';
